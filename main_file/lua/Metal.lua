...
mobjinfo[MT_METALIX] = {
    ...
    flags = MF_SPECIAL|MF_SHOOTABLE|MF_FLOAT|MF_SLIDEME|MF_NOGRAVITY|MF_BOSS|MF_GRENADEBOUNCE
}
...
mobjinfo[MT_CLASSICMETAL] = {
    ...
    flags = MF_SPECIAL|MF_SHOOTABLE|MF_FLOAT|MF_SLIDEME|MF_NOGRAVITY|MF_BOSS|MF_GRENADEBOUNCE|MF_NOCLIPTHING|MF_SPAWNCEILING
}
