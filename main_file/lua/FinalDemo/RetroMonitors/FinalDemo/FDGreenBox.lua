...
local RM_FD_GREENSHIELD_VARIANTS = {
	[0] = SH_ELEMENTAL, -- 2.0
	[1] = SH_BUBBLEWRAP, -- 1.09-1.09.4 (Didn't exist)
	[2] = SH_BUBBLEWRAP, -- 1.08
	[3] = SH_BUBBLEWRAP, -- 2K3-1.04
	[4] = SH_ELEMENTAL -- 1.1
}

function A_FDGreenShield(actor, var1, var2)
	if not (actor and actor.valid) then return end
	A_GiveShield(actor, RM_FD_GREENSHIELD_VARIANTS[actor.rmFDAltOption or 0], var2)
end
