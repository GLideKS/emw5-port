...
freeslot(
	...
	"S_FDBOX_YELLOW_IDLE",
	"S_FDBOX_YELLOW_ICON1",
	"S_FDBOX_YELLOW_ICON2"
)

addHook("MobjFuse", RM_FDMonitorFuseThink, MT_FDBOX_YELLOW)
...
mobjinfo[MT_FDBOX_YELLOW] = {
	...
	doomednum = 473,
	spawnstate = S_FDBOX_YELLOW_IDLE,
	spawnhealth = 1,
	painstate = S_FDBOX_YELLOW_IDLE,
	deathstate = S_FDBOX_EXPLOSION1,
	deathsound = sfx_pop,
	speed = 1,
	radius = 16*FRACUNIT,
	height = 32*FRACUNIT,
	damage = MT_FDBOX_YELLOW_ICON,
	flags = MF_SOLID|MF_SHOOTABLE|MF_MONITOR|MF_GRENADEBOUNCE
}

states[S_FDBOX_YELLOW_IDLE] =	{SPR_FBXY,	A,	2,	nil,	0,	0,	S_FDBOX_FLICKER}

mobjinfo[MT_FDBOX_YELLOW_ICON] = {
	doomednum = -1,
	spawnstate = S_FDBOX_YELLOW_ICON1,
	spawnhealth = 1,
	seesound = sfx_shield,
...
states[S_FDBOX_YELLOW_ICON1] =	{SPR_FBXY,	B,	18,	nil,			0,			0,	S_FDBOX_YELLOW_ICON2}
states[S_FDBOX_YELLOW_ICON2] =	{SPR_FBXY,	B,	18,	A_GiveShield,	SH_ATTRACT,	0,	S_NULL}
