...
LightObjects[MT_DOOMDBALL] = {
    color = SKINCOLOR_RED,
    states = {
        [S_DEATHBALL_1631] = {true, SKINCOLOR_SALMON},
        [S_DEATHBALL_1632] = {true},
        [S_DEATHBALL_1633] = {true, SKINCOLOR_SALMON},
        [S_DEATHBALL_1634] = {true, SKINCOLOR_PINK},
        [S_DOOMDBALL_1580] = {true, SKINCOLOR_PINK},
        [S_DOOMDBALL_1581] = {true, SKINCOLOR_PINK},
        [S_DOOMDBALL_1582] = {true, SKINCOLOR_PINK}
    },
    scale = FU*8,
    alpha = FU-(FU/3/2),
    floorlight = true,
...
LightObjects[MT_DEATHBALL] = {
    ...
    states = {
        ...
        [S_DEATHBALL_1633] = {true, SKINCOLOR_SALMON},
        [S_DEATHBALL_1634] = {true, SKINCOLOR_PINK},
        [S_DEATHBALL_1635] = {true, SKINCOLOR_PINK},
        [S_DEATHBALL_1636] = {true, SKINCOLOR_PINK},
        [S_DEATHBALL_1637] = {true, SKINCOLOR_PINK}
    },
